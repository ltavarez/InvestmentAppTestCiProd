...
{
    public class CreateInvestmentAssetCommandValidator : AbstractValidator<CreateInvestmentAssetCommand>
    {
        private readonly IAssetRepository _assetRepository;
        private readonly IInvestmentPortfolioRepository _investmentPortfolioRepository;
        public CreateInvestmentAssetCommandValidator(IAssetRepository assetRepository, IInvestmentPortfolioRepository investmentPortfolioRepository)
        {
